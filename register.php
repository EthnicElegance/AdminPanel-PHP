...
<body class="bg-silver-300">
    <div class="content">
        ...
        <form id="register-form" method="post">
            ...
            <div class="form-group">
                <input class="form-control" type="password" name="conpass" placeholder="Confirm Password">
            </div>
            ...
            <div class="form-group">
                <input class="btn btn-info btn-block" name="reg" value="Submit" type="submit">
            </div>
